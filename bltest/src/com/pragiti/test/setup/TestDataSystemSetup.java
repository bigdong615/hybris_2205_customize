 ...
 */
package com.pragiti.test.setup;
...
import com.pragiti.test.constants.BlTestConstants;
import com.pragiti.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = BlTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/bltest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/bltest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/bltest/import/cstickets.impex");
			...
			importImpexFile(context, "/bltest/import/csquotes.impex");
		}
	}
}
