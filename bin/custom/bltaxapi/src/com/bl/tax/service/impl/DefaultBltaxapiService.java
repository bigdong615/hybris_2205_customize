...
public class DefaultBltaxapiService implements BltaxapiService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultBltaxapiService.class);
	...
	{
		return DefaultBltaxapiService.class.getResourceAsStream("/bltaxapi/sap-hybris-platform.png");
	}
