...
public class DefaultBlloggingService implements BlloggingService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultBlloggingService.class);
	...
	{
		return DefaultBlloggingService.class.getResourceAsStream("/bllogging/sap-hybris-platform.png");
	}
