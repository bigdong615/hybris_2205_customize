...
import com.bl.core.enums.IssueFrequencyEnum;


/**
 *
 */
public class BlIssueFrequencyEnumTranslator extends AbstractValueTranslator
{
	...
	public Object importValue(final String value, final Item item) throws JaloInvalidParameterException
	{
		...
		{
			final IssueFrequencyEnum issueFrequencyEnum = enumerationService.getEnumerationValue(IssueFrequencyEnum.class, value);
			return issueFrequencyEnum;
		}
	return null;
	}
