 ...
 *
 */
public class BlInventoryLocCategoryEnumTranslator extends AbstractValueTranslator
{
	...
	public Object importValue(final String value, final Item item) throws JaloInvalidParameterException
	{
		...
		{
			final BlInventoryLocationCategoryEnum inventoryLocCategoryType = enumerationService
					.getEnumerationValue(BlInventoryLocationCategoryEnum.class, value);
			return inventoryLocCategoryType;
		}
		return null;
	}
