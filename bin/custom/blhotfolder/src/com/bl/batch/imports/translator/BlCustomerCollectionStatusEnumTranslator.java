 ...
 *
 */
public class BlCustomerCollectionStatusEnumTranslator extends AbstractValueTranslator
{
	...
	public Object importValue(final String value, final Item item) throws JaloInvalidParameterException
	{
		...
		{
			final CustomerCollectionStatusEnum cusCollectionEnum = enumerationService
					.getEnumerationValue(CustomerCollectionStatusEnum.class, value);
			return cusCollectionEnum;
		}
	return null;
	}
