...
import com.bl.core.enums.RepairLogStatusEnum;


/**
 *
 */
public class BlRepairLogStatusEnumTranslator extends AbstractValueTranslator
{
	...
	public Object importValue(final String value, final Item item) throws JaloInvalidParameterException
	{
		...
		{
			final RepairLogStatusEnum repairLogStatusEnum = enumerationService.getEnumerationValue(RepairLogStatusEnum.class, value);
			return repairLogStatusEnum;
		}
	return null;
	}
