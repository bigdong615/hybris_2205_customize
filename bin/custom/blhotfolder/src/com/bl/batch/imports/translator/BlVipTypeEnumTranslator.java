...
import com.bl.core.enums.VipTypeEnum;


/**
 *
 */
public class BlVipTypeEnumTranslator extends AbstractValueTranslator
{
	...
	public Object importValue(final String value, final Item item) throws JaloInvalidParameterException
	{
		...
		{
			final VipTypeEnum vipEnum = enumerationService.getEnumerationValue(VipTypeEnum.class, value);
			return vipEnum;
		}
	return null;
	}
