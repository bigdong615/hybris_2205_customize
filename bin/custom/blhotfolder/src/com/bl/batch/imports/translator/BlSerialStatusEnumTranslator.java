 ...
 *
 */
public class BlSerialStatusEnumTranslator extends AbstractValueTranslator
{
	...
	public Object importValue(final String value, final Item item) throws JaloInvalidParameterException
	{
		...
		{
			final SerialStatusEnum linkEnum = enumerationService.getEnumerationValue(SerialStatusEnum.class, value);
			return linkEnum;
		}
		return null;
	}
