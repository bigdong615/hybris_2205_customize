 ...
 *
 */
public class BlItemTestingEnumTranslator extends AbstractValueTranslator
{
	...
	public Object importValue(final String value, final Item item) throws JaloInvalidParameterException
	{
		...
		{
			final ItemTestingStatusEnum testingStatus = enumerationService.getEnumerationValue(ItemTestingStatusEnum.class, value);
