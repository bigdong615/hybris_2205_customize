...
import com.bl.core.enums.VendorsEnum;


/**
 *
 */
public class BlVendorsEnumTranslator extends AbstractValueTranslator
{
	...
	public Object importValue(final String value, final Item item) throws JaloInvalidParameterException
	{
		...
		{
			final VendorsEnum vendorsEnum = enumerationService.getEnumerationValue(VendorsEnum.class, value);
			return vendorsEnum;
		}
	return null;
	}
