...
import com.bl.core.enums.BehaviorEnum;


/**
 *
 */
public class BlBehaviorEnumTranslator extends AbstractValueTranslator
{
	...
	public Object importValue(final String value, final Item item) throws JaloInvalidParameterException
	{
		...
		{
			final BehaviorEnum behaviorEnum = enumerationService.getEnumerationValue(BehaviorEnum.class, value);
			return behaviorEnum;
		}
		return null;
	}
