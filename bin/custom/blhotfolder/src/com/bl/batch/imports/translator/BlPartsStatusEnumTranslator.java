...
import com.bl.core.enums.PartsStatusEnum;


/**
 *
 */
public class BlPartsStatusEnumTranslator extends AbstractValueTranslator
{
	...
	public Object importValue(final String value, final Item item) throws JaloInvalidParameterException
	{
		...
		{
			final PartsStatusEnum partsStatusEnum = enumerationService.getEnumerationValue(PartsStatusEnum.class, value);
			return partsStatusEnum;
		}
	return null;
	}
