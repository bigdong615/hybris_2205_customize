 ...
 *
 */
public class BlGearGaurdEnumTranslator extends AbstractValueTranslator
{
	...
	public Object importValue(final String value, final Item item) throws JaloInvalidParameterException
	{
		...
		{
			final GearGaurdEnum gearGaurdEnum = enumerationService.getEnumerationValue(GearGaurdEnum.class, value);
			return gearGaurdEnum;
		}
	return null;
	}
