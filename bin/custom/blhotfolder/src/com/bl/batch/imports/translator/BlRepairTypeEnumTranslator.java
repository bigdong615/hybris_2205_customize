 ...
 *
 */
public class BlRepairTypeEnumTranslator extends AbstractValueTranslator
{
	...
	public Object importValue(final String value, final Item item) throws JaloInvalidParameterException
	{
		...
		{
			final RepairTypeEnum repairType = enumerationService.getEnumerationValue(RepairTypeEnum.class, value);
			return repairType;
		}
		return null;
	}
