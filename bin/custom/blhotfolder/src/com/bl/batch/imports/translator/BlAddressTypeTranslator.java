 ...
 *
 */
public class BlAddressTypeTranslator extends AbstractValueTranslator
{
	...
	public Object importValue(final String value, final Item item) throws JaloInvalidParameterException
	{
		...
		{
			final AddressTypeEnum addressType = enumerationService.getEnumerationValue(AddressTypeEnum.class, value);
			return addressType;
		}
		return null;
	}
