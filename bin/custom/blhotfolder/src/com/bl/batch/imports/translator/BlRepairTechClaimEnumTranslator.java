...
import com.bl.core.enums.RepairTechClaimEnum;


/**
 *
 */
public class BlRepairTechClaimEnumTranslator extends AbstractValueTranslator
{
	...
	public Object importValue(final String value, final Item item) throws JaloInvalidParameterException
	{
		...
		{
			final RepairTechClaimEnum repairTechClaimEnum = enumerationService.getEnumerationValue(RepairTechClaimEnum.class, value);
			return repairTechClaimEnum;
		}
	return null;
	}
