...
import com.bl.core.enums.CustomerChargedEnum;


/**
 *
 */
public class BlCustomerChargedEnumTranslator extends AbstractValueTranslator
{
	...
	public Object importValue(final String value, final Item item) throws JaloInvalidParameterException
	{
		...
		{
			final CustomerChargedEnum customerChargedEnum = enumerationService.getEnumerationValue(CustomerChargedEnum.class, value);
			return customerChargedEnum;
		}
	return null;
	}
