...
import com.bl.core.enums.LinkSourceEnum;


/**
 *
 */
public class BlLinkSourceEnumTranslator extends AbstractValueTranslator
{
	...
	public Object importValue(final String value, final Item item) throws JaloInvalidParameterException
	{
		...
		{
			final LinkSourceEnum linkEnum = enumerationService.getEnumerationValue(LinkSourceEnum.class, value);
			return linkEnum;
		}
	return null;
	}
