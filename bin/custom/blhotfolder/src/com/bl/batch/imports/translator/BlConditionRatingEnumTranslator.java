 ...
 *
 */
public class BlConditionRatingEnumTranslator extends AbstractValueTranslator
{
	...
	public Object importValue(final String value, final Item item) throws JaloInvalidParameterException
	{
		...
		{
			final ConditionRatingValueEnum conditionRatingValue = enumerationService.getEnumerationValue(
					ConditionRatingValueEnum.class,
					value);
			return conditionRatingValue;
		}
		return null;
	}
