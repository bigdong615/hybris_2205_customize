...
import com.bl.core.enums.CustomerResponsibleEnum;


/**
 *
 */
public class BlCustomerResponsibleEnumTranslator extends AbstractValueTranslator
{
	...
	public Object importValue(final String value, final Item item) throws JaloInvalidParameterException
	{
		...
		{
			final CustomerResponsibleEnum customerResponsibleEnum = enumerationService
					.getEnumerationValue(CustomerResponsibleEnum.class, value);
			return customerResponsibleEnum;
		}
	return null;
	}
