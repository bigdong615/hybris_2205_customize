...
public class DefaultBlhotfolderService implements BlhotfolderService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultBlhotfolderService.class);
	...
	{
		return DefaultBlhotfolderService.class.getResourceAsStream("/blhotfolder/sap-hybris-platform.png");
	}
