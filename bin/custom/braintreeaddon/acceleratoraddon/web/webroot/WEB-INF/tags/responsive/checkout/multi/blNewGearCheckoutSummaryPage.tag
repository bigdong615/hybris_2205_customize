			...
			<div class="col-xl-10">
				<div class="row">
					<div id="order" class="col-lg-7">
						<h1>
							<spring:theme code="text.review.page.title.newgear" />
						</h1>
						<hr>
						<div class="reviewCart">
							<h5 class="mb-4">
								<spring:theme code="text.review.page.your.newgear" />
								<a href="#" class="edit-cart lightteal float-end reviewEdit"
									data-bs-toggle="modal" data-bs-target="#editWarning"
									data-section="newGearEntry" data-redirect-url="${cartPageUrl}">
            	...
            	<hr class="mt-5">
             	<div class="cart-actions">
            		...
            		<button id="placeOrder" type="button"
            			class="btn btn-sm btn-primary float-end js-place-order">
