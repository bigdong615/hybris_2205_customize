...
<input type="hidden" id="isDepositPaymentPage" name="isDepositPaymentPage" value="true" />
<div id="accountContent" class="col-lg-5 offset-lg-1">
	<h1>Charge Deposit</h1>
	<div class="extend-order">
		...
		<div class="row">
								...
								<c:otherwise>
									<button class="btn-checkbox" type="button"
										...
										<input type="radio"
											...
											id="paymentMethodPayPal" name="paymentMethodSelection"
											value="bt"> <label for="paymentMethodPayPal"></label>
									</button>
								</c:otherwise>
							</c:choose>
						</div>
			...
			<div class="cart-actions">
				<c:url value="/my-account/deposit-payment-success"
