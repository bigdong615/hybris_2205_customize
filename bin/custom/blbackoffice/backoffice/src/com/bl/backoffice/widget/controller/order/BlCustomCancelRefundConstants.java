...
import com.bl.constants.GeneratedBlloggingConstants;

/**
 * Cancel and Refund related constants
 *
 * @author Namrata Lohar
 */
public class BlCustomCancelRefundConstants extends GeneratedBlloggingConstants {
    ...
    public static final String OBJECTS_UPDATED = "objectsUpdated";
    ...
    public static final String REFUND_MESSAGE = "success.refund.transaction.message";
    public static final String PAYMENT_VOID_MESSAGE = "void.payment.transaction.message";
    public static final String CREATE_GIFT_CARD_MESSAGE = "create.gift.card.refund.process";
    ...
    public static final String CANCELORDER_MISSING_QUANTITY_HIGHER = "customersupportbackoffice.cancelorder.missing.quantity.higher";
    public static final String CANCELORDER_MISSING_QUANTITY = "customersupportbackoffice.cancelorder.missing.quantity";
    public static final String CANCELORDER_ERROR_REASON_HEADER = "customersupportbackoffice.cancelorder.error.reason";
    public static final String CANCELORDER_ERROR_REASON = "customersupportbackoffice.cancelorder.error.reason";
    public static final String EMPTY_AMOUNT_HEADER = "customersupportbackoffice.cancelorder.empty.amount.header";
