 ...
 */
package com.bl.integration.controllers;
...
import static com.bl.integration.constants.BlintegrationConstants.SAMPLE_LIST_DOUBLE_VALUE;
import static com.bl.integration.constants.BlintegrationConstants.SAMPLE_LIST_STRING_VALUE;
...
import com.bl.integration.data.UserDataList;
import com.bl.integration.dto.SampleWsDTO;
import com.bl.integration.dto.TestMapWsDTO;
import com.bl.integration.dto.UserWsDTO;
import com.bl.integration.dto.UsersListWsDTO;
import com.bl.integration.dto.UsersPageWsDTO;
import com.bl.integration.facades.SampleFacades;
...
public class SampleController
{
	 ...
	 * Example :</br>
	 * GET http://localhost:9001/blintegration/sample/dto/sampleValue
	 *
	 * @param pathVariable
	 ...
	 * Example :</br>
	 * URL : http://localhost:9001/blintegration/sample/dto</br>
	 * Method : POST</br>
	 ...
	 * <ul>
	 * <li>http://localhost:9001/blintegration/sample/users
	 * <li>http://localhost:9001/blintegration/sample/users?fields=users(info)
	 * <li>http://localhost:9001/blintegration/sample/users?fields=users(BASIC)
	 * <li>http://localhost:9001/blintegration/sample/users?fields=users(DEFAULT)
	 * <li>http://localhost:9001/blintegration/sample/users?fields=users(FULL)
	 * <li>http://localhost:9001/blintegration/sample/users?fields=users(firstName,addresses(street))
	 * </ul>
	 */
	 ...
	 * <ul>
	 * <li>http://localhost:9001/blintegration/sample/usersPaged
	 * <li>http://localhost:9001/blintegration/sample/usersPaged?currentPage=1
	 * <li>http://localhost:9001/blintegration/sample/usersPaged?currentPage=0?pageSize=1
	 * </ul>
	 */
	 ...
	 * <ul>
	 * <li>http://localhost:9001/blintegration/sample/users/user1
	 * <li>http://localhost:9001/blintegration/sample/users/user1?fields=info
	 * <li>http://localhost:9001/blintegration/sample/users/user1?fields=BASIC
	 * <li>http://localhost:9001/blintegration/sample/users/user1?fields=DEFAULT
	 * <li>http://localhost:9001/blintegration/sample/users/user1?fields=FULL
	 * <li>http://localhost:9001/blintegration/sample/users/user1?fields=firstName,addresses(street)
	 * </ul>
	 */
	 ...
	 *
	 * Url: http://localhost:9001/blintegration/sample/map
	 *
	 */
