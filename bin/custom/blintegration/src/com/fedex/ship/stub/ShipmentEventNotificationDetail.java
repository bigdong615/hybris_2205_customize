...
public class ShipmentEventNotificationDetail  implements java.io.Serializable {
    private com.fedex.ship.stub.ShipmentNotificationAggregationType aggregationType;

    private java.lang.String personalMessage;

    private com.fedex.ship.stub.ShipmentEventNotificationSpecification[] eventNotifications;

    public ShipmentEventNotificationDetail() {
    }

    public ShipmentEventNotificationDetail(
           com.fedex.ship.stub.ShipmentNotificationAggregationType aggregationType,
           java.lang.String personalMessage,
           com.fedex.ship.stub.ShipmentEventNotificationSpecification[] eventNotifications) {
     ...
     */
    public com.fedex.ship.stub.ShipmentNotificationAggregationType getAggregationType() {
        return aggregationType;
    }
     ...
     */
    public void setAggregationType(com.fedex.ship.stub.ShipmentNotificationAggregationType aggregationType) {
        this.aggregationType = aggregationType;
    }
     ...
     */
    public com.fedex.ship.stub.ShipmentEventNotificationSpecification[] getEventNotifications() {
        return eventNotifications;
    }
     ...
     */
    public void setEventNotifications(com.fedex.ship.stub.ShipmentEventNotificationSpecification[] eventNotifications) {
        this.eventNotifications = eventNotifications;
    }

    public com.fedex.ship.stub.ShipmentEventNotificationSpecification getEventNotifications(int i) {
        return this.eventNotifications[i];
    }

    public void setEventNotifications(int i, com.fedex.ship.stub.ShipmentEventNotificationSpecification _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v28", "ShipmentEventNotificationDetail"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("aggregationType");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v28", "AggregationType"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v28", "ShipmentNotificationAggregationType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("personalMessage");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v28", "PersonalMessage"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v28", "EventNotifications"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v28", "ShipmentEventNotificationSpecification"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
