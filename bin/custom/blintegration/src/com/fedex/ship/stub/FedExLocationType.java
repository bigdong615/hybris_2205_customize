...
public class FedExLocationType implements java.io.Serializable {
    ...
    public static final java.lang.String _FEDEX_ONSITE = "FEDEX_ONSITE";
    ...
    public static final java.lang.String _FEDEX_SHIP_AND_GET = "FEDEX_SHIP_AND_GET";
    ...
    public static final FedExLocationType FEDEX_ONSITE = new FedExLocationType(_FEDEX_ONSITE);
    ...
    public static final FedExLocationType FEDEX_SHIP_AND_GET = new FedExLocationType(_FEDEX_SHIP_AND_GET);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v28", "FedExLocationType"));
    }
    /**
