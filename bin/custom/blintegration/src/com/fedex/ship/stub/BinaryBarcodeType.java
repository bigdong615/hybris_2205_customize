...
public class BinaryBarcodeType implements java.io.Serializable {
    ...
    public static BinaryBarcodeType fromValue(java.lang.String value)
        ...
        BinaryBarcodeType enumeration = (BinaryBarcodeType)
            _table_.get(value);
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(BinaryBarcodeType.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v28", "BinaryBarcodeType"));
    }
    /**
