...
public class EtdAttributeType implements java.io.Serializable {
    ...
    public static EtdAttributeType fromValue(java.lang.String value)
        ...
        EtdAttributeType enumeration = (EtdAttributeType)
            _table_.get(value);
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(EtdAttributeType.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v28", "EtdAttributeType"));
    }
    /**
