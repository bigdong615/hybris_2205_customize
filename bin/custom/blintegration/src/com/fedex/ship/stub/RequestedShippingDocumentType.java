...
public class RequestedShippingDocumentType implements java.io.Serializable {
    ...
    public static final RequestedShippingDocumentType USMCA_CERTIFICATION_OF_ORIGIN = new RequestedShippingDocumentType(_USMCA_CERTIFICATION_OF_ORIGIN);
    public static final RequestedShippingDocumentType USMCA_COMMERCIAL_INVOICE_CERTIFICATION_OF_ORIGIN = new RequestedShippingDocumentType(_USMCA_COMMERCIAL_INVOICE_CERTIFICATION_OF_ORIGIN);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v28", "RequestedShippingDocumentType"));
    }
    /**
