...
public class ShippingDocumentNamingType implements java.io.Serializable {
    ...
    public static ShippingDocumentNamingType fromValue(java.lang.String value)
        ...
        ShippingDocumentNamingType enumeration = (ShippingDocumentNamingType)
            _table_.get(value);
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ShippingDocumentNamingType.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v28", "ShippingDocumentNamingType"));
    }
    /**
