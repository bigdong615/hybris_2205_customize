...
public class BatteryMaterialType implements java.io.Serializable {
    ...
    public static BatteryMaterialType fromValue(java.lang.String value)
        ...
        BatteryMaterialType enumeration = (BatteryMaterialType)
            _table_.get(value);
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(BatteryMaterialType.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v28", "BatteryMaterialType"));
    }
    /**
