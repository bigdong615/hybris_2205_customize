...
public class UploadDocumentType implements java.io.Serializable {
    ...
    public static final UploadDocumentType USMCA_CERTIFICATION_OF_ORIGIN = new UploadDocumentType(_USMCA_CERTIFICATION_OF_ORIGIN);
    public static final UploadDocumentType USMCA_COMMERCIAL_INVOICE_CERTIFICATION_OF_ORIGIN = new UploadDocumentType(_USMCA_COMMERCIAL_INVOICE_CERTIFICATION_OF_ORIGIN);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v28", "UploadDocumentType"));
    }
    /**
