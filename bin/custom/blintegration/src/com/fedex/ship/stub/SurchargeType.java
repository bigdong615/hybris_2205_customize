...
public class SurchargeType implements java.io.Serializable {
    ...
    public static final java.lang.String _ACCOUNT_NUMBER_PROCESSING_FEE = "ACCOUNT_NUMBER_PROCESSING_FEE";
    ...
    public static final java.lang.String _HIGH_COST_SERVICE_AREA_DESTINATION = "HIGH_COST_SERVICE_AREA_DESTINATION";
    public static final java.lang.String _HIGH_COST_SERVICE_AREA_ORIGIN = "HIGH_COST_SERVICE_AREA_ORIGIN";
    ...
    public static final java.lang.String _ON_DEMAND_CARE = "ON_DEMAND_CARE";
    ...
    public static final java.lang.String _OVER_LENGTH = "OVER_LENGTH";
    public static final java.lang.String _PEAK = "PEAK";
    public static final java.lang.String _PEAK_ADDITIONAL_HANDLING = "PEAK_ADDITIONAL_HANDLING";
    public static final java.lang.String _PEAK_OVERSIZE = "PEAK_OVERSIZE";
    public static final java.lang.String _PEAK_RESIDENTIAL_DELIVERY = "PEAK_RESIDENTIAL_DELIVERY";
    ...
    public static final SurchargeType ACCOUNT_NUMBER_PROCESSING_FEE = new SurchargeType(_ACCOUNT_NUMBER_PROCESSING_FEE);
    public static final SurchargeType ADDITIONAL_HANDLING = new SurchargeType(_ADDITIONAL_HANDLING);
    public static final SurchargeType ADDRESS_CORRECTION = new SurchargeType(_ADDRESS_CORRECTION);
    ...
    public static final SurchargeType DELIVERY_ON_INVOICE_ACCEPTANCE = new SurchargeType(_DELIVERY_ON_INVOICE_ACCEPTANCE);
    ...
    public static final SurchargeType HIGH_COST_SERVICE_AREA_DESTINATION = new SurchargeType(_HIGH_COST_SERVICE_AREA_DESTINATION);
    public static final SurchargeType HIGH_COST_SERVICE_AREA_ORIGIN = new SurchargeType(_HIGH_COST_SERVICE_AREA_ORIGIN);
    ...
    public static final SurchargeType ON_DEMAND_CARE = new SurchargeType(_ON_DEMAND_CARE);
    ...
    public static final SurchargeType OVER_LENGTH = new SurchargeType(_OVER_LENGTH);
    public static final SurchargeType PEAK = new SurchargeType(_PEAK);
    public static final SurchargeType PEAK_ADDITIONAL_HANDLING = new SurchargeType(_PEAK_ADDITIONAL_HANDLING);
    public static final SurchargeType PEAK_OVERSIZE = new SurchargeType(_PEAK_OVERSIZE);
    public static final SurchargeType PEAK_RESIDENTIAL_DELIVERY = new SurchargeType(_PEAK_RESIDENTIAL_DELIVERY);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v28", "SurchargeType"));
    }
    /**
