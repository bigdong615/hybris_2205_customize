...
public class ShipmentDryIceDetail  implements java.io.Serializable {
    ...
    private com.fedex.ship.stub.ShipmentDryIceProcessingOptionsRequested processingOptions;
    ...
    public ShipmentDryIceDetail(
           ...
           com.fedex.ship.stub.ShipmentDryIceProcessingOptionsRequested processingOptions) {
     ...
     */
    public com.fedex.ship.stub.ShipmentDryIceProcessingOptionsRequested getProcessingOptions() {
        return processingOptions;
    }
     ...
     */
    public void setProcessingOptions(com.fedex.ship.stub.ShipmentDryIceProcessingOptionsRequested processingOptions) {
        this.processingOptions = processingOptions;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v28", "ShipmentDryIceDetail"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v28", "ShipmentDryIceProcessingOptionsRequested"));
