...
public class CarrierCodeType implements java.io.Serializable {
    ...
    public static final java.lang.String _FDXO = "FDXO";
    ...
    public static final CarrierCodeType FDXO = new CarrierCodeType(_FDXO);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v28", "CarrierCodeType"));
    }
    /**
