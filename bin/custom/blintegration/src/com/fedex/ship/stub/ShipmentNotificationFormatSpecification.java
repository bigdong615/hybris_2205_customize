...
public class ShipmentNotificationFormatSpecification  implements java.io.Serializable {
    private com.fedex.ship.stub.NotificationFormatType type;

    public ShipmentNotificationFormatSpecification() {
    }

    public ShipmentNotificationFormatSpecification(
           com.fedex.ship.stub.NotificationFormatType type) {
           this.type = type;
    }
     ...
     * @return type
     */
    public com.fedex.ship.stub.NotificationFormatType getType() {
        return type;
    }
     ...
     * @param type
     */
    public void setType(com.fedex.ship.stub.NotificationFormatType type) {
        this.type = type;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v28", "ShipmentNotificationFormatSpecification"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("type");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v28", "Type"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v28", "NotificationFormatType"));
