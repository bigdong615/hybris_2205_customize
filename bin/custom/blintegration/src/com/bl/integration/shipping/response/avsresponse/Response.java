...
public class Response {
    ...
    protected List<com.bl.integration.response.jaxb.Error> error;
     ...
     * 
     */
    public List<com.bl.integration.response.jaxb.Error> getError() {
        if (error == null) {
            error = new ArrayList<com.bl.integration.response.jaxb.Error>();
        }
        return this.error;
    }
