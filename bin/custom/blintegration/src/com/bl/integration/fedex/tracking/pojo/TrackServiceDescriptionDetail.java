...
public class TrackServiceDescriptionDetail  implements java.io.Serializable {
     ...
     *
     * @return type   * This field contains the service type values, like PRIORITY_OVERNIGHT
     * and FEDEX_GROUND.
     */
     ...
     *
     * @param type   * This field contains the service type values, like PRIORITY_OVERNIGHT
     * and FEDEX_GROUND.
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v19", "TrackServiceDescriptionDetail"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/track/v19", "ShortDescription"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
