...
public class NaftaNetCostMethodCode implements java.io.Serializable {
    ...
    // Constructor
    protected NaftaNetCostMethodCode(String value) {
        _value_ = value;
    ...
    public static NaftaNetCostMethodCode fromValue(String value)
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v19", "NaftaNetCostMethodCode"));
    }
    /**
