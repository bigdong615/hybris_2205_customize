...
public class CommodityPurposeType implements java.io.Serializable {
    ...
    // Constructor
    protected CommodityPurposeType(String value) {
        _value_ = value;
    ...
    public static CommodityPurposeType fromValue(String value)
    ...
    public static CommodityPurposeType fromString(String value)
          throws IllegalArgumentException {
