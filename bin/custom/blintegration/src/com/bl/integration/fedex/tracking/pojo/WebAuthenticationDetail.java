...
public class WebAuthenticationDetail  implements java.io.Serializable {
    ...
    private  WebAuthenticationCredential parentCredential;

    /* Credential used to authenticate a specific software application.
     * This value is provided by FedEx after registration. */
    private  WebAuthenticationCredential userCredential;

    public WebAuthenticationDetail() {
    }

    public WebAuthenticationDetail(
            WebAuthenticationCredential parentCredential,
            WebAuthenticationCredential userCredential) {
     ...
     */
    public void setParentCredential( WebAuthenticationCredential parentCredential) {
        this.parentCredential = parentCredential;
    }
     ...
     * This value is provided by FedEx after registration.
     */
    public void setUserCredential( WebAuthenticationCredential userCredential) {
        this.userCredential = userCredential;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v19", "WebAuthenticationDetail"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("parentCredential");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/track/v19", "ParentCredential"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v19", "WebAuthenticationCredential"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("userCredential");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/track/v19", "UserCredential"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v19", "WebAuthenticationCredential"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
