...
public class ShipmentNotificationFormatSpecification  implements java.io.Serializable {
    private  NotificationFormatType type;

    public ShipmentNotificationFormatSpecification() {
    }

    public ShipmentNotificationFormatSpecification(
            NotificationFormatType type) {
           this.type = type;
    }
     ...
     * @param type
     */
    public void setType( NotificationFormatType type) {
        this.type = type;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v19", "ShipmentNotificationFormatSpecification"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("type");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/track/v19", "Type"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v19", "NotificationFormatType"));
