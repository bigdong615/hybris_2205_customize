...
public class TrackingDocumentDispositionType implements java.io.Serializable {
    ...
    // Constructor
    protected TrackingDocumentDispositionType(String value) {
        _value_ = value;
    ...
    public static TrackingDocumentDispositionType fromValue(String value)
    ...
    public static TrackingDocumentDispositionType fromString(String value)
          throws IllegalArgumentException {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v19", "TrackingDocumentDispositionType"));
    }
    /**
