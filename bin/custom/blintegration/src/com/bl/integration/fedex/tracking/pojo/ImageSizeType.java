...
public class ImageSizeType implements java.io.Serializable {
    ...
    // Constructor
    protected ImageSizeType(String value) {
        _value_ = value;
    ...
    public static ImageSizeType fromValue(String value)
    ...
    public static ImageSizeType fromString(String value)
          throws IllegalArgumentException {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v19", "ImageSizeType"));
    }
    /**
