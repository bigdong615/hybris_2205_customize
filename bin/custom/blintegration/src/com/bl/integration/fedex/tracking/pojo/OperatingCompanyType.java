...
public class OperatingCompanyType implements java.io.Serializable {
    ...
    // Constructor
    protected OperatingCompanyType(String value) {
        _value_ = value;
    ...
    public static OperatingCompanyType fromValue(String value)
    ...
    public static OperatingCompanyType fromString(String value)
          throws IllegalArgumentException {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v19", "OperatingCompanyType"));
    }
    /**
