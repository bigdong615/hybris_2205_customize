...
public class TrackDetailAttributeType implements java.io.Serializable {
    ...
    // Constructor
    protected TrackDetailAttributeType(String value) {
        _value_ = value;
        _table_.put(_value_,this);
    }

    public static final String _INCLUDED_IN_WATCHLIST = "INCLUDED_IN_WATCHLIST";
    ...
    public static TrackDetailAttributeType fromValue(String value)
    ...
    public static TrackDetailAttributeType fromString(String value)
          throws IllegalArgumentException {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v19", "TrackDetailAttributeType"));
    }
    /**
