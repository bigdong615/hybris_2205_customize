...
public class SpecialInstructionStatusDetail  implements java.io.Serializable {
    ...
    private  SpecialInstructionsStatusCode status;
    ...
    public SpecialInstructionStatusDetail(
            SpecialInstructionsStatusCode status,
     ...
     */
    public void setStatus( SpecialInstructionsStatusCode status) {
        this.status = status;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v19", "SpecialInstructionStatusDetail"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("status");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/track/v19", "Status"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v19", "SpecialInstructionsStatusCode"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("statusCreateTime");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/track/v19", "StatusCreateTime"));
