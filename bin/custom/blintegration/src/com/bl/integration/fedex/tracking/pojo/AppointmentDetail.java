...
public class AppointmentDetail  implements java.io.Serializable {
    ...
    private AppointmentTimeDetail[] windowDetails;
    ...
    public AppointmentDetail(
           java.util.Date date,
           AppointmentTimeDetail[] windowDetails) {
           this.date = date;
     ...
     */
    public  AppointmentTimeDetail[] getWindowDetails() {
     ...
     */
    public void setWindowDetails( AppointmentTimeDetail[] windowDetails) {
        this.windowDetails = windowDetails;
    }

    public  AppointmentTimeDetail getWindowDetails(int i) {
        return this.windowDetails[i];
    }

    public void setWindowDetails(int i,  AppointmentTimeDetail _value) {
    ...
    public synchronized int hashCode() {
        ...
        if (getWindowDetails() != null) {
            for (int i=0;
                 ...
                 i++) {
                Object obj = java.lang.reflect.Array.get(getWindowDetails(), i);
                if (obj != null &&
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v19", "AppointmentDetail"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("date");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/track/v19", "Date"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/track/v19", "WindowDetails"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v19", "AppointmentTimeDetail"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
