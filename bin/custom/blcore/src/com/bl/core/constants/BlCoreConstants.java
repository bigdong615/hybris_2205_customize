...
public final class BlCoreConstants extends GeneratedBlCoreConstants
{
	...
	public static final int LAST_LOC_PRTY_FOR_BIN_WO_PARENT = 8;
  ...
  public static final String USER_RESTRICTION = "hasUserRestriction";
	...
	public static final String BL_ORDER_PREPARE_INTERCEPTOR = "BlOrderPrepareInterceptor";
   ...
   public static final String MASKED_CARD_FORMAT = "****%s";
	...
	public static final String CUSTOMER_MARKETING_EVENT_DEFINITION_KEY ="customer.email.marketing.event.definition.key";
