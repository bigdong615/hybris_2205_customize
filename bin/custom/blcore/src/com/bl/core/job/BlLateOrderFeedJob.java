...
public class BlLateOrderFeedJob extends AbstractJobPerformable<CronJobModel> {
  ...
  private File getFile() {
    ...
    final String fileName = new StringBuilder(BlespintegrationConstants.LATE_ORDER_FILE_NAME_PREFIX).append(Config.getParameter(BlespintegrationConstants.TEST_FILE_EXTENSION)).append(BlespintegrationConstants.RETURN_ORDER_FILE_SUFFIX).toString();
