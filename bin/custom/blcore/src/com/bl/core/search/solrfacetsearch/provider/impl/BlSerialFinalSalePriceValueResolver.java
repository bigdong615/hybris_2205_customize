...
/**
 * This class is responsible to send FinalSalePrice to SOLR Document from Hybris for finalSalePrice attribute of
 * BlSerialProduct
 *
 * @author Ravikumar
 *
			...
			final ValueResolverContext<Object, Object> valueResolverContext) throws FieldValueProviderException
	{
		...
		catch (final Exception exception)
		{
			BlLogger.logFormattedMessage(LOG, Level.ERROR, LogErrorCodeEnum.SOLR_INDEXING_ERROR.getCode(), exception,
					"Failed to resolve value for minSerialfinalSalePrice attribute for product with code: {}",
