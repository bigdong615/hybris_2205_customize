...
public class BlLenseProductTypeValueProvider extends AbstractPropertyFieldValueProvider implements FieldValueProvider
{

	private static final Logger LOG = Logger.getLogger(BlLenseProductTypeValueProvider.class);
			...
			final Object model)
	{
		if (model instanceof BlProductModel)
		{
			...
			if (((BlProductModel) model).getProductType().getCode().equals(ProductTypeEnum.LENSES.getCode()))
			{
			...
			final IndexedProperty indexedProperty)
	{
		...
		if (language != null)
		{
			...
			for (final String fieldName : fieldNames)
			{
				fieldValues.add(new FieldValue(fieldName, value + " " + "lens lenses"));
			}
		}
		else
		{
