...
public class BlOtherProductTypeValueProvider extends AbstractPropertyFieldValueProvider implements FieldValueProvider
{
			...
			final IndexedProperty indexedProperty)
	{
		...
		if (language != null)
		{
			...
			final String status = product.getProductType().getCode();
