 ...
 */
package com.bl.core.suggestion.impl;
...
public class DefaultSimpleSuggestionService implements SimpleSuggestionService {
  ...
  public List<ProductModel> getReferencesForPurchasedInCategory(final CategoryModel category,
      ...
      final Integer limit) {
    return getSimpleSuggestionDao()
        .findProductsRelatedToPurchasedProductsByCategory(category, user, referenceType,
  ...
  public List<ProductModel> getReferencesForPurchasedInCategory(final CategoryModel category,
      ...
      final Integer limit) {
    return getSimpleSuggestionDao()
        .findProductsRelatedToPurchasedProductsByCategory(category, referenceTypes, user,
            excludePurchased, limit);
  }
  ...
  public List<ProductModel> getReferencesForProducts(final List<ProductModel> products,
    ...
    return getSimpleSuggestionDao()
        .findProductsRelatedToProducts(products, referenceTypes, user, excludePurchased, limit);
  }
