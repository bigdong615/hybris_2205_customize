...
//    System.out.println("After filter consigner serial i.e. owned by BL serial size:" + consignerSerial.size())
    ...
    System.out.println("Product Code" + saparaterString + "Article Number" + saparaterString + "Barcode" + saparaterString + "SerialStatus" + saparaterString + "Warehouse Location" + saparaterString+ "OC Location" + saparaterString +"Last Location Scan Parent");
