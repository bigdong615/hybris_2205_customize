 ...
 *
 */
package com.braintree.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(BraintreefulfilmentprocessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(BraintreefulfilmentprocessConstants.PARENT_PROCESS);
