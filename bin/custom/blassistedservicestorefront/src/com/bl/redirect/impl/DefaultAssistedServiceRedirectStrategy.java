...
import com.bl.redirect.AssistedServiceRedirectStrategy;
...
public class DefaultAssistedServiceRedirectStrategy implements AssistedServiceRedirectStrategy
{
	...
	public String getRedirectPath()
	{
		...
		if (StringUtils.isNotBlank(request.getParameter(REDIRECT_PARAMETER)))
		{
	...
	{
		return Config.getString(BlassistedservicestorefrontConstants.REDIRECT_ERROR, DEFAULT_ERROR_REDIRECT);
	}

	protected String getPathWithCart()
	{
		return Config.getString(BlassistedservicestorefrontConstants.REDIRECT_WITH_CART, DEFAULT_CART_REDIRECT);
	}

	protected String getPathCustomerOnly()
	{
		return Config.getString(BlassistedservicestorefrontConstants.REDIRECT_CUSTOMER_ONLY, DEFAULT_CUSTOMER_REDIRECT);
	}

	protected String getPathWithOrder(final String redirectOrderId)
	{
		return String.format(Config.getString(BlassistedservicestorefrontConstants.REDIRECT_WITH_ORDER, DEFAULT_ORDER_REDIRECT),
				redirectOrderId);
	}
