...
public class ChannelDecisionAspect
{
	...
	public void decideAround(final ProceedingJoinPoint joinPoint) throws Throwable //NOSONAR
	{
	...
	protected boolean isAssistedServiceMode(final ProceedingJoinPoint joinPoint)
	{
	...
	protected void processSecureChannelProcessor(final ProceedingJoinPoint joinPoint) throws IOException, ServletException
	{
	...
	protected void processChannelDecisionManager(final ProceedingJoinPoint joinPoint) throws Throwable
	{
