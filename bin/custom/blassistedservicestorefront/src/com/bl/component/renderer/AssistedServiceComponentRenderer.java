 ...
 */
package com.bl.component.renderer;
...
public class AssistedServiceComponentRenderer<C extends AbstractCMSComponentModel> extends DefaultAddOnCMSComponentRenderer<C>
{
	...
	{
		final String asmRequestParam = pageContext.getRequest().getParameter(BlassistedservicestorefrontConstants.ASM_REQUEST_PARAM);
