...
import com.bl.security.AssistedServiceAgentAuthoritiesManager;
import com.bl.security.impl.AssistedServiceAgentLoginStrategy;
import com.bl.security.impl.AssistedServiceAgentLogoutStrategy;
import com.bl.security.impl.AssistedServiceAuthenticationToken;
import de.hybris.platform.assistedservicefacades.user.data.AutoSuggestionCustomerData;
import com.bl.util.SubscriptionFacadeReflectionWrapper;
...
{
	private static final String ASSISTED_SERVICE_COMPONENT = "addon:/blassistedservicestorefront/cms/asm/assistedServiceComponent";
	...
	protected boolean isASAgent(final UserModel currentUser)
	{
		...
		{
			if (BlassistedservicestorefrontConstants.AS_AGENT_GROUP_UID.equals(userGroup.getUid()))
			{
				return true;
			}
		}
