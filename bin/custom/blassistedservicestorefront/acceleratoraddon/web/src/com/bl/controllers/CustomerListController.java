...
public class CustomerListController extends AbstractSearchPageController
{
	...
	public String getCustomersListPopup(final Model model, final HttpServletResponse response)
	{
		...
		return BlassistedservicestorefrontControllerConstants.Views.Fragments.CustomerListComponent.ASM_CUSTOMER_LIST_POPUP;
	}
			...
			@RequestParam(value = "query", required = false) final String query)
	{
		...
		return BlassistedservicestorefrontControllerConstants.Views.Fragments.CustomerListComponent.ASM_CUSTOMER_LIST_TABLE;
	}
