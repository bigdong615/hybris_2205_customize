...
public class AdditionalInformationController
{
	...
	private static final String CUSTOMER_360_PAGE = "addon:/blassistedservicestorefront/pages/customer360";
	private static final String CUSTOMER_360_FRAGMENT_404_PAGE = "addon:/blassistedservicestorefront/fragments/customer360/fragment404";
	private static final String CUSTOMER_360_SECTION = "addon:/blassistedservicestorefront/pages/section";
			...
			final String sectionId, final HttpServletResponse response)
	{
		...
		model.addAttribute(AIF_AJAX_TIMEOUT, Integer.valueOf(Config.getInt(BlassistedservicestorefrontConstants.AIF_TIMEOUT,
				BlassistedservicestorefrontConstants.AIF_DEFAULT_TIMEOUT)));
