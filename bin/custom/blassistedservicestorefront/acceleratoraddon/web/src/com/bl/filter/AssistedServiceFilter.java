...
import com.bl.restrictions.AssistedServicePathRestrictionEvaluator;
...
public class AssistedServiceFilter extends OncePerRequestFilter
{
			...
			final FilterChain filterchain) throws ServletException, IOException
	{
		...
		final String asmRequestParam = httpservletrequest.getParameter(BlassistedservicestorefrontConstants.ASM_REQUEST_PARAM);
	...
	{
		final String cookieName = Config.getString(BlassistedservicestorefrontConstants.PROFILE_COOKIE_NAME, BlassistedservicestorefrontConstants.ASM_PROFILE_TRACKING_PAUSE_COOKIE);
		final StringBuilder buf = new StringBuilder(cookieName);
		buf.append("=");
		buf.append(StringUtils.EMPTY);

		final long age = BlassistedservicestorefrontConstants.IMPERSISTENCE_COOKIE_INDEX;
		buf.append("; Max-Age=\"");
		buf.append(age);
		buf.append("\"");
