...
<div class="row overview-tab-charts">
    <div class="col-sm-12 devices-used-chart">
        ...
        <script type="application/javascript">
            ...
            ACC.blassistedservicestorefront.buildArrayValues(labels, '${device.deviceName}');
            ACC.blassistedservicestorefront.buildArrayValues(values, '${device.value}');
            </c:forEach>
            ACC.blassistedservicestorefront.drawDoughnutChart("${canvasId}", labels, values);
        </script>
    </div>
</div>
