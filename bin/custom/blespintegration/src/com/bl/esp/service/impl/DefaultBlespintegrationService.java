...
public class DefaultBlespintegrationService implements BlespintegrationService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultBlespintegrationService.class);
	...
	{
		return DefaultBlespintegrationService.class.getResourceAsStream("/blespintegration/sap-hybris-platform.png");
	}
