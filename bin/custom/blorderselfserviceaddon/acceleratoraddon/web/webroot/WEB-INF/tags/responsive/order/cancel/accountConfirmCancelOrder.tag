...
<%@ attribute name="orderEntryCancelForm" type="com.bl.forms.OrderEntryCancelForm " %>
...
<form:form action="${request.contextPath}/my-account/order/${fn:escapeXml(order.code)}/cancel/submit"
           ...
           class="account-confirm-cancel-order">
    <ul class="item__list cart__list cancel-order__list">
        ...
        <c:forEach items="${order.entries}" var="entry" varStatus="loop">
            <c:if test="${!entry.product.multidimensional && orderEntryCancelForm.cancelEntryQuantityMap[entry.entryNumber] > 0 }">
                ...
                <li class="item__list--item">
                    ...
                    <div class="item__info">
                        <ycommerce:testId code="confirmCancel_product_name">
            ...
            <c:if test="${entry.product.multidimensional}">
                <c:forEach items="${entry.entries}" var="nentry" varStatus="nloop">
                    ...
                    <c:if test="${orderEntryCancelForm.cancelEntryQuantityMap[nentry.entryNumber] > 0}">
            ...
            <div class="cancel-actions">
                <div class="row">
                    ...
                    <div class="col-sm-6 col-sm-offset-6">
                        <button type="submit" class="btn btn-primary btn-block" id="submitcancelorderformvbutton">
                            <spring:theme code="text.account.cancel.submit"/>
                        </button>
                    </div>
