...
/**
 * Provides necessary meta information about the tealiumiqaddon hmc extension.
 * 
 * 
 * @version ExtGen v5.2.0.0
 */
public class TealiumIQHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(TealiumIQHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "com.tealium.addon.hmc.locales";
