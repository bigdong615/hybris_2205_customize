                                          ...
                                          <sec:authorize access="!hasAnyRole('ROLE_ANONYMOUS')">
                                               ...
                                               <c:choose>
                                                  ...
                                                  <c:otherwise>
                                                   ...
                                                   <c:url var="rentalPDPUrl" value="/rent/product/${productReference.target.code}"/>
                                                   <h6 class="product"><a href="${rentalPDPUrl}" onclick="return productClickTealiumEvent('${product.code}');">${fn:escapeXml(productReference.target.name)}</a></h6>
                                                   ...
                                                   <c:choose>
                                                        ...
                                                        <c:otherwise>
                                                             <span class="period">${rentalDate.numberOfDays}&nbsp;<spring:theme code="pdp.rental.product.recommendation.section.day.rental.text"/></span></h6>
                                                        </c:otherwise>
                                                   </c:choose>
                                                    <c:choose>
