								...
								<div class="reviewCart pb-0">
									...
									<div class="row">
										<div class="col-5">
											...
											<p class="printQuoteDate mb-0">
												<b>${orderData.rentalDatesOnPrint.selectedFromDate}</b>
											</p>
											<p class="body14">
												<c:choose>
													<c:when
										...
										<div class="col-5">
											...
											<p class="printQuoteDate mb-0">
												<b>${orderData.rentalDatesOnPrint.selectedToDate}</b>
											</p>
											<p class="body14">
												<c:choose>
													<c:when
										...
										<div class="row mb-4">
											...
											<div class="col-md-9 mt-3">
												<p class="gray80 body14">
													...
													<c:choose>
														<c:when
															test="${cartEntry.gearGuardProFullWaiverSelected }">
																+ <spring:theme
														...
														<c:when test="${cartEntry.gearGuardWaiverSelected }">
																+ <spring:theme
																code="text.review.page.damage.waiver.gear" />
															<br>
														</c:when>
														<c:otherwise>
																+ <spring:theme
						...
						<div class="col-md-5">
							<div id="orderSummary" class="card">
								...
								<c:if test="${orderData.isRentalCart}">
									<hr>
									<p>
										<b><spring:theme code="text.rental.cart.date" /></b>&emsp;${orderData.rentalDates.selectedFromDate}
										- ${orderData.rentalDates.selectedToDate}
									</p>
								</c:if>
								<hr>
									...
									<tbody>
										<tr>
											<td class="gray80"><spring:theme
													code="text.checkout.multi.order.summary.cost" /></td>
										...
										<tr>
											<td class="gray80"><spring:theme
												...
												data-bs-toggle="modal" data-bs-target="#damageWaivers"><i
													class="icon-support"></i></a></td>
											<td class="text-end"><format:blPrice
													priceData="${orderData.totalDamageWaiverCost}" /></td>
										</tr>
										<tr>
											<td class="gray80"><spring:theme
							...
							<div class="notification notification-warning">
								<spring:theme
									code="text.review.print.page.your.rental.order.summery.warning" />
							</div>
