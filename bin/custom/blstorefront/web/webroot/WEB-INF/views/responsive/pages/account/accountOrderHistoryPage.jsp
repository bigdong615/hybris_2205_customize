...
<spring:htmlEscape defaultHtmlEscape="true" />
                          ...
                          <c:if test="${order.rentalCart}">
													<div class="col-5 col-md-3">
														...
														<p class="body14">
															<spring:theme code="text.myaccount.order.rental.Starts" />
														</p>
													</div>
													...
													<div class="col-5 col-md-3">
														...
														<p class="body14">
															<spring:theme code="text.myaccount.order.rental.ends" />
														</p>
													</div>
													...
													<div class="col-6 col-md-1">
														...
														<c:url value="/my-account/order/${order.code}" var="viewOrderAction" />
																	<a href="${viewOrderAction}">
																		<spring:theme code="text.myaccount.order.view" />
																	</a>
																</li>
																<li>
																	<a href="#">
