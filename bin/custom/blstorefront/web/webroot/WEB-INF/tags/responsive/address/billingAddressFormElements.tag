...
<%@ taglib prefix="cart" tagdir="/WEB-INF/tags/responsive/cart" %>
		...
		<formElement:formSelectBox idKey="address.region" labelKey="" path="billTo_state" mandatory="true" skipBlank="false" skipBlankMessageKey="address.selectState" items="${regions}" itemValue="isocode" tabindex="${tabindex + 7}" selectCSSClass="form-control"/>
		...
		<formElement:formInputBox idKey="address.phone" labelKey="" placeholder="address.phone" path="billTo_phoneNumber" inputCSS="form-control" mandatory="false" />
