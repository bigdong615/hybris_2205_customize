 ...
 */
package com.bl.Ordermanagement.actions.email;
...
public class GenerateEmailWithAttachmentAction extends AbstractSimpleDecisionAction
{
	...
	protected boolean generateEmail(final BusinessProcessModel businessProcessModel, final EmailMessageModel emailMessageModel)
	{
		if (emailMessageModel != null)
		{
			...
			{
				throw new IllegalArgumentException("Business Process is not a return process type");
			}
	...
	{
		if (!(ReturnRequestModel.RETURNLABEL.equals(propertyName) || ReturnRequestModel.RETURNFORM.equals(propertyName)))
		{
			throw new IllegalArgumentException("Expected returnLabel or returnForm");
		}
	}
