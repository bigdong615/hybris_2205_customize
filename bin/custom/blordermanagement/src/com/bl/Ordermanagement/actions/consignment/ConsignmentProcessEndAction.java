...
public class ConsignmentProcessEndAction extends AbstractProceduralAction<ConsignmentProcessModel>
{
	...
	public void executeAction(final ConsignmentProcessModel process)
	{
		...
		final String eventId =
				process.getParentProcess().getCode() + "_" + BlOrdermanagementConstants.ORDER_ACTION_EVENT_NAME;
		...
		LOG.debug("Process: {} fired event {}", process.getCode(), BlOrdermanagementConstants.ORDER_ACTION_EVENT_NAME);
	}
}
