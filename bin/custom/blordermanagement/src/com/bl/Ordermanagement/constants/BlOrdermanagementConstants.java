 ...
 *
 */
package com.bl.Ordermanagement.constants;

@SuppressWarnings("PMD")
public class BlOrdermanagementConstants extends GeneratedBlOrdermanagementConstants
{
	public static final String EXTENSIONNAME = "blordermanagement";
