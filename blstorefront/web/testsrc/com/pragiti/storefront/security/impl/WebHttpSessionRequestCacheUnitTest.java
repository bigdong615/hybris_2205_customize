...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/blstorefront/electronics/en",
						"https://electronics.local:9002/blstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/blstorefront/electronics/en",
						"https://electronics.local:9002/blstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/blstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/blstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/blstorefront/electronics/en",
						"https://electronics.local:9002/blstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/blstorefront",
						"https://electronics.local:9002/blstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/blstorefront",
						"https://electronics.local:9002/blstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/blstorefront/electronics/en",
						"https://electronics.local:9002/blstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
