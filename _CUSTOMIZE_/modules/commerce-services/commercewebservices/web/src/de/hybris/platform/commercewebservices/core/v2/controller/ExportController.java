...
import de.hybris.platform.commercewebservices.core.product.data.ProductDataList;
...
public class ExportController extends BaseController
{
	...
	@ResponseBody
	@ApiOperation(nickname = "getExportedProducts", value = "Get a list of product exports.", notes = "Used for product export. Depending on the timestamp parameter, it can return all products or only products modified after the given time.")
	@ApiBaseSiteIdParam
